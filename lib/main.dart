...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() { // _private
    setState(() { //state class provide
      _counter++;
    });
  }
  ...
  @override
  Widget build(BuildContext context) {
    return Scaffold( //material style
      appBar: AppBar(
      ...
      floatingActionButton: FloatingActionButton( // scaffold style provides
